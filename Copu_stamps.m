...
if ~exist('new_dataset_path','var') || isempty(dataset_path)
    new_dataset_path = 'C:\Users\usuario\Videos\Videos\';
end
...
for subject_idx = 1:number_subjects
    ...
    for class_idx = 1:number_classes
        ...
        Newfolder = fullfile(new_dataset_path, class_name, strcat('Subject_', num2str(subject_idx)));
        movefile(copy_path,Newfolder); 
...
%                 sample_folders(sample_idx).name, 'EsqueletoRGB.csv');
